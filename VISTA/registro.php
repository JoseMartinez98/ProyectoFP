<head>
    ...
    <div class="centrarForm">
      <h2> REGISTRARSE</h2>
      <form class="form1" id="formRegistro" action="../CONTROLADOR/crearUsuario.php" method="post">
        <div class="campoF1">
        <input class="input-linea" type ="nombre" name="nombre"></imput>
        ...
        <br>
        <div class="campoF1">
        <input class="input-linea" type="number" name="edad"></imput>
        <label for="number">Edad</label>
        </div>
        <br>
        <div class="campoF1">
        <input class="input-linea" type="email" name="email"></imput>
        <label for="email"> Email</label>
        </div>
        <br>
        <button class="boton" type="submit" name="botonRegistro" id="botonRegistro" value = "Registrar">REGISTRAR</button>
      </form>
    </div>
